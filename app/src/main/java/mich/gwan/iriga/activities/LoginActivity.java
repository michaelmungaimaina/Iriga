package mich.gwan.iriga.activities;
...
import mich.gwan.iriga.activities.admin.ControlActivity;
import mich.gwan.iriga.helpers.InputValidation;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.textViewLinkRegister:
                ...
                Intent intentRegister = new Intent(getApplicationContext(), mich.gwan.iriga.activities.RegisterActivity.class);
    ...
    private void verifyFromSQLite() {
            ...
            if (databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim(), textInputEditTextPassword.getText().toString().trim())) {
                ...
                Snackbar snackbar = Snackbar.make(nestedScrollView,  "Iriga Session Opened Successfully", Snackbar.LENGTH_LONG);
