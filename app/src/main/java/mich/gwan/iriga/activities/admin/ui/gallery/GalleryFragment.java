package mich.gwan.iriga.activities.admin.ui.gallery;
...
import mich.gwan.iriga.adapters.AllSale.AllsaleRecyclerAdapter;
import mich.gwan.iriga.adapters.pdf.PDFUtility;
import mich.gwan.iriga.databinding.FragmentGalleryBinding;
...
public class GalleryFragment extends Fragment implements PDFUtility.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Iriga/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_AllSales.pdf";
        }
        return path;
    }
    ...
    private List<String[]> getSampleData()
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            temp.add(new String[] {sales.getSaleDate(),sales.getSaleTime(), sales.getSalecategory(),
   ...
   // private void deleteItem(int position) {
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_iriga_allsale_data.xls";
