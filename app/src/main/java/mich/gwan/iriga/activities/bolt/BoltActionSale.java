...
import static mich.gwan.iriga.sql.DatabaseHelper.COLUMN_BOLT_CATEGORY;
import static mich.gwan.iriga.sql.DatabaseHelper.COLUMN_BOLT_QUANTIY;
import static mich.gwan.iriga.sql.DatabaseHelper.TABLE_BOLT;
...
import mich.gwan.iriga.databinding.ActivityBoltSaleBinding;
