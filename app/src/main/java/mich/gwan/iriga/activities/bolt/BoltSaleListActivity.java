...
import mich.gwan.iriga.adapters.bolt.BoltSaleRecyclerAdapter;
import mich.gwan.iriga.adapters.pdf.PDFBolt;
import mich.gwan.iriga.databinding.ActivityBoltssalesListBinding;
...
public class BoltSaleListActivity extends AppCompatActivity implements PDFBolt.OnDocumentClose {
    ...
    private  void initViews(){
        ...
        froDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                froDatePickerDialog = new DatePickerDialog(BoltSaleListActivity.this, new DatePickerDialog.OnDateSetListener() {
        ...
        toDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                toDatePickerDialog = new DatePickerDialog(BoltSaleListActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @SuppressLint("SetTextI18n")
                    @Override
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        if (dayOfMonth < 10 ){
    ...
    public void onPDFDocumentClose(File file)
    {
        ...
        try {
            ...
            Toast.makeText(BoltSaleListActivity.this,"There is no app to load corresponding PDF",Toast.LENGTH_LONG).show();
