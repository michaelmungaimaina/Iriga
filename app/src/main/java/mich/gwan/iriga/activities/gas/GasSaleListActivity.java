package mich.gwan.iriga.activities.gas;
...
import mich.gwan.iriga.adapters.gas.GasSaleRecyclerAdapter;
import mich.gwan.iriga.adapters.pdf.PDFBolt;
import mich.gwan.iriga.adapters.pdf.PDFGas;
import mich.gwan.iriga.databinding.ActivityGassalesListBinding;
...
public class GasSaleListActivity extends AppCompatActivity implements PDFGas.OnDocumentClose {
    ...
    private  void initViews(){
        ...
        froDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                froDatePickerDialog = new DatePickerDialog(GasSaleListActivity.this, new DatePickerDialog.OnDateSetListener() {
        ...
        toDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                toDatePickerDialog = new DatePickerDialog(GasSaleListActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @SuppressLint("SetTextI18n")
                    @Override
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        if (dayOfMonth < 10 ){
    ...
    public void onPDFDocumentClose(File file)
    {
        ...
        try {
            ...
            Toast.makeText(GasSaleListActivity.this,"There is no app to load corresponding PDF",Toast.LENGTH_LONG).show();
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS) + "/"  + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_bolt.pdf";
        }
        else
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Iriga/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_bolt.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_iriga_gas_sale_data.xls";
