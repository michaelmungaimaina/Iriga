package mich.gwan.iriga.activities.oil;
...
import mich.gwan.iriga.activities.LoginActivity;
import mich.gwan.iriga.activities.bolt.BoltSaleListActivity;
import mich.gwan.iriga.activities.spare.SpareSaleListActivity;
import mich.gwan.iriga.adapters.oil.OilSaleRecyclerAdapter;
import mich.gwan.iriga.adapters.pdf.PDFBolt;
import mich.gwan.iriga.adapters.pdf.PDFOil;
import mich.gwan.iriga.databinding.ActivityOilsalesListBinding;
...
public class OilSaleListActivity extends AppCompatActivity implements PDFOil.OnDocumentClose {
    ...
    private  void initViews(){
        ...
        froDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                froDatePickerDialog = new DatePickerDialog(OilSaleListActivity.this, new DatePickerDialog.OnDateSetListener() {
    ...
    public void onPDFDocumentClose(File file)
    {
        ...
        try {
            ...
            Toast.makeText(OilSaleListActivity.this,"There is no app to load corresponding PDF",Toast.LENGTH_LONG).show();
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS) + "/"  + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_oil.pdf";
        }
        else
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Iriga/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_oil.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        xssfRow.createCell(5).setCellValue(totalT());
        xssfRow.createCell(6).setCellValue(totalProfit());

        DateTimeFormatter m = DateTimeFormatter.ofPattern("yyyyMMddHHmmss");
        LocalDateTime t = LocalDateTime.now();
        String filename = m.format(t) + "_iriga_oil_sale_data.xls";
                    ...
                    if (froDatePicker.getText() == "" && toDatePicker.getText() == ""){
                        ...
                        new AsyncTask<Void, Void, Void>() {
                            ...
                            protected void onPostExecute(Void aVoid) {
                                ...
                                textNetProfit.setText(String.valueOf(totalProfit()));
                                textNetTotal.setText(String.valueOf(totalT()));
                            }
                        }.execute();
                    }
                  ...
                  if(froDatePicker.getText() != "" && toDatePicker.getText() != "" ) {
                        new AsyncTask<Void, Void, Void>() {
                            ...
                            protected void onPostExecute(Void aVoid) {
                                super.onPostExecute(aVoid);
                                oilSaleRecyclerAdapter.notifyDataSetChanged();
                                textNetProfit.setText(String.valueOf(databaseHelper.getAllOilSaleProfit((String) froDatePicker.getText(), (String) toDatePicker.getText(), textInputEditText.getText().toString().toUpperCase())));
                            }
                        }.execute();
                    }
    ...
    private void getOilSaleDataFromSQLite() {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected void onPostExecute(Void aVoid) {
                super.onPostExecute(aVoid);
                oilSaleRecyclerAdapter.notifyDataSetChanged();
                textNetProfit.setText((String.valueOf(databaseHelper.getAllOilSaleProfit())));
                textNetTotal.setText(String.valueOf(databaseHelper.getAllOilSaleTotal()));
