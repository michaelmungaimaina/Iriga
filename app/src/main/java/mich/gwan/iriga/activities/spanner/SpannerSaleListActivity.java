package mich.gwan.iriga.activities.spanner;
...
import mich.gwan.iriga.adapters.pdf.PDFSpanner;
import mich.gwan.iriga.adapters.spanner.SpannerSaleRecyclerAdapter;
import mich.gwan.iriga.databinding.ActivitySpannersalesListBinding;
...
public class SpannerSaleListActivity extends AppCompatActivity implements PDFSpanner.OnDocumentClose {
    ...
    private  void initViews(){
        ...
        froDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                froDatePickerDialog = new DatePickerDialog(SpannerSaleListActivity.this, new DatePickerDialog.OnDateSetListener() {
        ...
        toDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                toDatePickerDialog = new DatePickerDialog(SpannerSaleListActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @SuppressLint("SetTextI18n")
                    @Override
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        if (dayOfMonth < 10 ){
    ...
    public void onPDFDocumentClose(File file)
    {
        ...
        try {
            ...
            Toast.makeText(SpannerSaleListActivity.this,"There is no app to load corresponding PDF",Toast.LENGTH_LONG).show();
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Iriga/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_spannnr.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_iriga_spanner_sale_data.xls";
