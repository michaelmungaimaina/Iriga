package mich.gwan.iriga.activities.spare;
...
import mich.gwan.iriga.adapters.pdf.PDFSpare;
import mich.gwan.iriga.adapters.spare.SpareSaleRecyclerAdapter;
import mich.gwan.iriga.databinding.ActivitySparesalesListBinding;
...
public class SpareSaleListActivity extends AppCompatActivity implements PDFSpare.OnDocumentClose {
    ...
    private  void initViews(){
        ...
        froDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                froDatePickerDialog = new DatePickerDialog(SpareSaleListActivity.this, new DatePickerDialog.OnDateSetListener() {
        ...
        toDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                toDatePickerDialog = new DatePickerDialog(SpareSaleListActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @SuppressLint("SetTextI18n")
                    @Override
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        if (dayOfMonth < 10 ){
    ...
    public void onPDFDocumentClose(File file)
    {
        ...
        try {
            ...
            Toast.makeText(SpareSaleListActivity.this,"There is no app to load corresponding PDF",Toast.LENGTH_LONG).show();
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Iriga/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_spare.pdf";
        }
        return path;
    }
    ...
    private List<String[]> getSampleData()
    {
        ...
        temp.add(new String[] {"TOTAL", "", "", "", "", String.valueOf(total() + ".00"), String.valueOf(profit() + ".00")});
        return  temp;
    }
    public int total(){
        int total = 0;
    ...
    public int profit(){
        int prof = 0;
        for(int i = 0; i < listSpareSale.size(); i++) {
            prof += listSpareSale.get(i).getSpareSaleProfit();
        }
        return  prof;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_iriga_spare_sale_data.xls";
                    ...
                    if (froDatePicker.getText() == "" && toDatePicker.getText() == ""){
                        ...
                        new AsyncTask<Void, Void, Void>() {
                            ...
                            protected void onPostExecute(Void aVoid) {
                                ...
                                textNetProfit.setText((String.valueOf(databaseHelper.getAllSpareSaleProfit())));
                                textNetTotal.setText(String.valueOf(databaseHelper.getAllSpareSaleTotal()));
                            }
                        }.execute();
                    }
                            ...
                            new AsyncTask<Void, Void, Void>() {
                                ...
                                protected void onPostExecute(Void aVoid) {
                                    super.onPostExecute(aVoid);
                                    spareSaleRecyclerAdapter.notifyDataSetChanged();
                                    textNetProfit.setText(String.valueOf(profit()));
                                    textNetTotal.setText(String.valueOf(total()));
                                }
                            }.execute();
                    }
