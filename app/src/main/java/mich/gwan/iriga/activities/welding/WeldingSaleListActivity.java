package mich.gwan.iriga.activities.welding;
...
import mich.gwan.iriga.adapters.pdf.PDFWelding;
import mich.gwan.iriga.adapters.welding.WeldingSaleRecyclerAdapter;
import mich.gwan.iriga.databinding.ActivityWeldingsalesListBinding;
...
public class WeldingSaleListActivity extends AppCompatActivity implements PDFWelding.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Iriga/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_welding.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_iriga_welding_sale_data.xls";
