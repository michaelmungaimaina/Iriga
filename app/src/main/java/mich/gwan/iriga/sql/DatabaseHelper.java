...
import mich.gwan.iriga.model.Employee;
import mich.gwan.iriga.model.Note;
import mich.gwan.iriga.model.User;
...
import mich.gwan.iriga.model.gas.Gas;
import mich.gwan.iriga.model.gas.GasSale;
import mich.gwan.iriga.model.oil.Oil;
import mich.gwan.iriga.model.oil.OilSale;
import mich.gwan.iriga.model.powersaw.Powersaw;
import mich.gwan.iriga.model.powersaw.PowersawSale;
import mich.gwan.iriga.model.spanner.Spanner;
import mich.gwan.iriga.model.spanner.SpannerSale;
import mich.gwan.iriga.model.spare.Spare;
import mich.gwan.iriga.model.spare.SpareSale;
import mich.gwan.iriga.model.welding.Welding;
import mich.gwan.iriga.model.welding.WeldingSale;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    // Database Name
    private static String DATABASE_NAME = "Igoji.db";
   ...
   // private static final String COLUMN_EMPLOYEE_STATION = "employee_station";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        for (int i = 0; i < getAllSale(db).size(); i++){
            AllSales all = getAllSale(db).get(i);
            String m = all.getSaleDate();
            String newDate = String.valueOf(m.charAt(6)).concat(String.valueOf(m.charAt(7))).concat(String.valueOf(m.charAt(8))).concat(String.valueOf(m.charAt(9))).concat(String.valueOf(m.charAt(5))).concat(String.valueOf(m.charAt(3))).concat(String.valueOf(m.charAt(4))).concat(String.valueOf(m.charAt(2))).concat(String.valueOf(m.charAt(0))).concat(String.valueOf(m.charAt(1)));
            all.setSaleDate(newDate);
            updateAllSale(all, db);
        }
        for (int i = 0; i < getAllOilSale(db).size(); i++){
            OilSale all = getAllOilSale(db).get(i);
            String m = all.getOilSaleDate();
            String newDate = String.valueOf(m.charAt(6)).concat(String.valueOf(m.charAt(7))).concat(String.valueOf(m.charAt(8))).concat(String.valueOf(m.charAt(9))).concat(String.valueOf(m.charAt(5))).concat(String.valueOf(m.charAt(3))).concat(String.valueOf(m.charAt(4))).concat(String.valueOf(m.charAt(2))).concat(String.valueOf(m.charAt(0))).concat(String.valueOf(m.charAt(1)));
            all.setOilSaleDate(newDate);
            updateOIlSale(all, db);
        }
        for (int i = 0; i < getAllSpareSale(db).size(); i++){
            SpareSale all = getAllSpareSale(db).get(i);
            String m = all.getSpareSaleDate();
            String newDate = String.valueOf(m.charAt(6)).concat(String.valueOf(m.charAt(7))).concat(String.valueOf(m.charAt(8))).concat(String.valueOf(m.charAt(9))).concat(String.valueOf(m.charAt(5))).concat(String.valueOf(m.charAt(3))).concat(String.valueOf(m.charAt(4))).concat(String.valueOf(m.charAt(2))).concat(String.valueOf(m.charAt(0))).concat(String.valueOf(m.charAt(1)));
            all.setSpareSaleDate(newDate);
            updateSpareSale(all, db);
        }
        for (int i = 0; i < getAllPowersawSale(db).size(); i++){
            PowersawSale all = getAllPowersawSale(db).get(i);
            String m = all.getPowersawSaleDate();
            String newDate = String.valueOf(m.charAt(6)).concat(String.valueOf(m.charAt(7))).concat(String.valueOf(m.charAt(8))).concat(String.valueOf(m.charAt(9))).concat(String.valueOf(m.charAt(5))).concat(String.valueOf(m.charAt(3))).concat(String.valueOf(m.charAt(4))).concat(String.valueOf(m.charAt(2))).concat(String.valueOf(m.charAt(0))).concat(String.valueOf(m.charAt(1)));
            all.setPowersawSaleDate(newDate);
            updatePowersawSale(all, db);
        }
        for (int i = 0; i < getAllSpannerSale(db).size(); i++){
            SpannerSale all = getAllSpannerSale(db).get(i);
            String m = all.getSpannerSaleDate();
            String newDate = String.valueOf(m.charAt(6)).concat(String.valueOf(m.charAt(7))).concat(String.valueOf(m.charAt(8))).concat(String.valueOf(m.charAt(9))).concat(String.valueOf(m.charAt(5))).concat(String.valueOf(m.charAt(3))).concat(String.valueOf(m.charAt(4))).concat(String.valueOf(m.charAt(2))).concat(String.valueOf(m.charAt(0))).concat(String.valueOf(m.charAt(1)));
            all.setSpannerSaleDate(newDate);
            updateSpannerSale(all, db);
        }
        for (int i = 0; i < getAllWeldingSale(db).size(); i++){
            WeldingSale all = getAllWeldingSale(db).get(i);
            String m = all.getWeldingSaleDate();
            String newDate = String.valueOf(m.charAt(6)).concat(String.valueOf(m.charAt(7))).concat(String.valueOf(m.charAt(8))).concat(String.valueOf(m.charAt(9))).concat(String.valueOf(m.charAt(5))).concat(String.valueOf(m.charAt(3))).concat(String.valueOf(m.charAt(4))).concat(String.valueOf(m.charAt(2))).concat(String.valueOf(m.charAt(0))).concat(String.valueOf(m.charAt(1)));
            all.setWeldingSaleDate(newDate);
            updateWeldingSale(all, db);
        }
        for (int i = 0; i < getAllBoltSale(db).size(); i++){
            BoltSale all = getAllBoltSale(db).get(i);
            String m = all.getBoltSaleDate();
            String newDate = String.valueOf(m.charAt(6)).concat(String.valueOf(m.charAt(7))).concat(String.valueOf(m.charAt(8))).concat(String.valueOf(m.charAt(9))).concat(String.valueOf(m.charAt(5))).concat(String.valueOf(m.charAt(3))).concat(String.valueOf(m.charAt(4))).concat(String.valueOf(m.charAt(2))).concat(String.valueOf(m.charAt(0))).concat(String.valueOf(m.charAt(1)));
            all.setBoltSaleDate(newDate);
            updateBoltsSale(all, db);
        }
        for (int i = 0; i < getAllGasSale(db).size(); i++){
            GasSale all = getAllGasSale(db).get(i);
            String m = all.getGasSaleDate();
            String newDate = String.valueOf(m.charAt(6)).concat(String.valueOf(m.charAt(7))).concat(String.valueOf(m.charAt(8))).concat(String.valueOf(m.charAt(9))).concat(String.valueOf(m.charAt(5))).concat(String.valueOf(m.charAt(3))).concat(String.valueOf(m.charAt(4))).concat(String.valueOf(m.charAt(2))).concat(String.valueOf(m.charAt(0))).concat(String.valueOf(m.charAt(1)));
            all.setGasSaleDate(newDate);
            updateGasSale(all, db);
        }**/
   ...
   public void addUser(User user) {
    ...
    public List<Oil> getAllOil(){
        ...
        //Sorting order
        String oilSortOder = COLUMN_OIL_ID + " ASC";
    ...
    @SuppressLint("Range")
    public List<OilSale> getAllOilSale(SQLiteDatabase db){
        //Columns to fetch
        String[] oilSaleColumns = {
                COLUMN_OILSALE_DAY,
                COLUMN_OILSALE_TIME,
    ...
    public List<AllSales> getAllSale(){
        ...
        if (oilSaleCursor.moveToFirst()){
            do{
                ...
                sale.setSaleId(Integer.parseInt(oilSaleCursor.getString(oilSaleCursor.getColumnIndex(COLUMN_SALE_COUNT))));
    ...
    @SuppressLint("Range")
    public List<AllSales> getAllSale(SQLiteDatabase db){
        //Columns to fetch
        String[] saleColumns = {
                COLUMN_SALE_COUNT,
                COLUMN_SALE_DAY,
    ...
    @SuppressLint("Range")
    public List<GasSale> getAllGasSale(SQLiteDatabase db){
        //Columns to fetch
        String[] columns = {
                COLUMN_GASSALE_DAY,
                COLUMN_GASSALE_TIME,
    ...
    @SuppressLint("Range")
    public List<PowersawSale> getAllPowersawSale(SQLiteDatabase db){
        //Columns to fetch
        String[] columns = {
                COLUMN_POWERSAWSALE_DAY,
                COLUMN_POWERSAWSALE_TIME,
    ...
    @SuppressLint("Range")
    public List<SpannerSale> getAllSpannerSale(SQLiteDatabase db){
        //Columns to fetch
        String[] columns = {
                COLUMN_SPANNERSALE_DAY,
                COLUMN_SPANNERSALE_TIME,
    ...
    @SuppressLint("Range")
    public List<WeldingSale> getAllWeldingSale(SQLiteDatabase db){
        //Columns to fetch
        String[] columns = {
                COLUMN_WELDINGSALE_DAY,
                COLUMN_WELDINGSALE_TIME,
    ...
    @SuppressLint("Range")
    public List<BoltSale> getAllBoltSale(SQLiteDatabase db){
        //Columns to fetch
        String[] columns = {
                COLUMN_BOLTSALE_DAY,
                COLUMN_BOLTSALE_TIME,
    ...
    @SuppressLint("Range")
    public List<SpareSale> getAllSpareSale(SQLiteDatabase db){
        //Columns to fetch
        String[] saleColumns = {
                COLUMN_SPARESALE_DAY,
                COLUMN_SPARESALE_TIME,
   ...
   /**
    ...
    public void updateOIlSale(OilSale oilSale,SQLiteDatabase db) {
    ...
    public void updateGasSale(GasSale sale,SQLiteDatabase db) {
    ...
    public void updateSpareSale(SpareSale spareSale, SQLiteDatabase db) {
        ContentValues values = new ContentValues();
    ...
    public void updateSpannerSale(SpannerSale par, SQLiteDatabase db) {
        ContentValues values = new ContentValues();
        values.put(COLUMN_SPANNERSALE_DAY, par.getSpannerSaleDate());
        db.update(TABLE_SPANNER_SALES, values, COLUMN_SPANNERSALE_TIME + " = ?",
                new String[]{String.valueOf(par.getSpannerSaleTime())});
    }
    public void updateWeldingSale(WeldingSale par, SQLiteDatabase db) {
        ContentValues values = new ContentValues();
        values.put(COLUMN_WELDINGSALE_DAY, par.getWeldingSaleDate());
        db.update(TABLE_WELDING_SALES, values, COLUMN_WELDINGSALE_TIME + " = ?",
                new String[]{String.valueOf(par.getWeldingSaleTime())});
    }
    public void updatePowersawSale(PowersawSale par, SQLiteDatabase db) {
        ContentValues values = new ContentValues();
        values.put(COLUMN_POWERSAWSALE_DAY, par.getPowersawSaleDate());
        db.update(TABLE_POWERSAW_SALES, values, COLUMN_POWERSAWSALE_TIME + " = ?",
                new String[]{String.valueOf(par.getPowersawSaleTime())});
    }
    public void updateBoltsSale(BoltSale par, SQLiteDatabase db) {
        ContentValues values = new ContentValues();
        values.put(COLUMN_BOLTSALE_DAY, par.getBoltSaleDate());
        db.update(TABLE_BOLT_SALES, values, COLUMN_BOLTSALE_TIME + " = ?",
                new String[]{String.valueOf(par.getBoltSaleTime())});
    }
    ...
    /**
     * Method to update allsale record by Id
     */
    public void updateAllSale(AllSales par, SQLiteDatabase db){
        //SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COLUMN_SALE_DAY, par.getSaleDate());

        db.update(TABLE_ALL_SALE, values, COLUMN_SALE_COUNT + " = ?", new String[]{String.valueOf(par.getSaleId())});
        //db.close();
    }
    /**
